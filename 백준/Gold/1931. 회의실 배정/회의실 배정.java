...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 회의의 시작시간과 끝나는 시간이 주어짐
        // 한개의 회의실
        // 이어서 사용 가능한 회의의 최대 개수를 구해야 함
        // 회의 시간이 짧을 수록 좋은 것
        // 회의 시작 시간도 작고 끝나는 시간도 짧아야 함
        // 시작시간으로 정렬, 끝나는 시간으로 정렬
        // 거기에 이어서 바로 회의가 들어갈 수 있어야 함


        // 내 생각 이 틀림 회의 점유 시간도 짧아야 함
        ...
        for(int i=1; i<N; i++) { // 회의 정렬해 놨기 때문에, 그냥 앞에서부터 접근
            if(meeting[i][0] < cur) continue; // 현재 미팅의 끝나는 시간보다 시작 시간이 빠르면 넘어가기
